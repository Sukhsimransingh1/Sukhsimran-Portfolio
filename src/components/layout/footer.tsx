...
export function Footer() {
  return (
    <footer className="bg-[#171717] px-6 py-12 text-[#f5f1e9] sm:px-10 lg:px-16">
        ...
        <div className="flex flex-col justify-between gap-10 border-b border-white/10 pb-10 md:flex-row md:items-end">
          <div>
            <p className="text-2xl font-medium tracking-[-0.04em]">
              Sukhsimran Singh<span className="text-[#ef775f]">.</span>
            </p>

            <p className="mt-3 text-sm text-white/45">
              AI/ML · Generative AI · AI Engineering
            </p>
          </div>
